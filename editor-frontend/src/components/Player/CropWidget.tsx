...
const CropWidget = ({left, top, aspectRatio}: CropWidgetProps) => {
  ...
  const style = transform ? {
    ...
    background: 'url("https://cms-cdn.now.gg/cms-media/2023/10/11-grid-lines.png") 0% 0% / cover no-repeat, center center rgba(255, 255, 255, 0.05)'
  } : {
    top: `${top}px`,
    left: `${left}px`,
    aspectRatio: aspectRatio,
  ...
  return (
      <div className={`draggable absolute h-full box-content`} ref={setNodeRef} style={style} {...listeners} {...attributes}>
        {/* <div className="svg-arrow-wrapper relative h-full w-full">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="42" height="4" viewBox="0 0 42 4" fill="none" className="svg-2 absolute top-0 left-1/2">
            <path d="M40 2H2" stroke="#FF42A5" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <svg xmlns="http://www.w3.org/2000/svg" width="42" height="4" viewBox="0 0 42 4" fill="none" className="svg-3 absolute bottom-0 left-1/2">
            <path d="M40 2H2" stroke="#FF42A5" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="4" height="42" viewBox="0 0 4 42" fill="none" className="svg-6 absolute left-0 top-1/2">
            <path d="M2 2L2 40" stroke="#FF42A5" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <svg xmlns="http://www.w3.org/2000/svg" width="4" height="42" viewBox="0 0 4 42" fill="none" className="svg-7 absolute right-0 top-1/2">
            <path d="M2 2L2 40" stroke="#FF42A5" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
