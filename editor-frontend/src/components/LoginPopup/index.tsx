      ...
      <div className="modal-body">
        <div className="modal-parent">
          ...
          <div className="flex column perfectCenter">
            ...
            <a className="sign-up-btn flex perfectCenter" href={`https://stagingngg.net/accounts/auth/v1/identifier?provider=google&continue=${location.href}`}>
            ...
            <div className="social-icons flex">
              <a className="discord flex perfectCenter" href={`https://stagingngg.net/accounts/oauth2/v1/auth?provider=discord&continue=${location.href}`}>
                <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a className="facebook flex perfectCenter" href={`https://stagingngg.net/accounts/oauth2/v1/auth?provider=facebook&continue=${location.href}`}>
